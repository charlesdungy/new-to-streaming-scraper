...
Data are retrieved from two different data sources: rottentomates.com (RT) and whatsonnetflix.com (WON). RT data are cleaned and transformed with Python, while WON data are cleaned and transformed with R.
